...
CREATE TABLE `atest` (
  ...
  `user_id` int(10) unsigned DEFAULT NULL COMMENT '用户名',
...
INSERT INTO `atest` VALUES (1,1,'1','b',NULL,'0000-00-00 00:00:00',NULL,NULL,NULL,NULL,NULL),(2,1,'2','a',NULL,'0000-00-00 00:00:00',NULL,NULL,NULL,NULL,NULL),(3,1,'3','a',NULL,'0000-00-00 00:00:00',NULL,NULL,NULL,NULL,NULL),(4,1,'4','b',NULL,'0000-00-00 00:00:00',NULL,NULL,NULL,NULL,NULL),(5,1,'45','c',NULL,'0000-00-00 00:00:00',NULL,NULL,NULL,NULL,NULL),(6,1,'123','c',NULL,'0000-00-00 00:00:00',NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `backup` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='备份';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `broadband` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='宽带';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `broadband_cat` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='宽带类别';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `log` VALUES (1,'/Broadband/edit/id/1.html',NULL,'{\"id\":\"1\",\"user_id\":\"1\",\"phone\":\"123455\",\"cat_id\":\"1\",\"start_date\":\"2012-12-12\",\"end_date\":\"2012-12-','0','0.0.0.0','1','1369589811','0'),(2,'/Log/edit.html?id=1',NULL,'{\"id\":\"1\",\"operate\":\"\\/Broadband\\/edit\\/id\\/1.html\",\"para\":null,\"content\":\"{\\\"id\\\":\\\"1\\\",\\\"user_id\\\"','0','0.0.0.0','1','1369595453','0'),(3,'/Menu/edit/id/72.html',NULL,'{\"id\":\"72\",\"name\":null,\"title\":\"\\u5907\\u4efd\",\"link\":\"Database\\/backup\",\"pid\":\"71\",\"level\":\"2\",\"orde','0','0.0.0.0','1','1369596223','0'),(4,'/Menu/edit/id/72.html',NULL,'{\"id\":\"72\",\"name\":\"\\u5907\\u4efd\\u5217\\u8868\",\"title\":\"\\u5907\\u4efd\\u5217\\u8868\",\"link\":\"Database\\/in','0','0.0.0.0','1','1369596378','0'),(5,'/Menu/edit/id/72.html',NULL,'{\"id\":\"72\",\"name\":\"\\u5907\\u4efd\\u5217\\u8868\",\"title\":\"\\u5907\\u4efd\\u5217\\u8868\",\"link\":\"Database\\/ba','0','0.0.0.0','1','1369596445','0'),(6,'/Menu/edit/id/71.html',NULL,'{\"id\":\"71\",\"name\":\"\\u6570\\u636e\\u5e93\\u5907\\u4efd\",\"title\":\"\\u6570\\u636e\\u5e93\\u5907\\u4efd\",\"link\":\"','0','0.0.0.0','1','1369596465','0'),(7,'/Menu/edit/id/71.html',NULL,'{\"id\":\"71\",\"name\":\"\\u6570\\u636e\\u5e93\\u5907\\u4efd\",\"title\":\"\\u6570\\u636e\\u5907\\u4efd\",\"link\":\"Databa','0','0.0.0.0','1','1369596648','0'),(8,'/Menu/edit/id/72.html',NULL,'{\"id\":\"72\",\"name\":\"\\u5907\\u4efd\\u5217\\u8868\",\"title\":\"\\u5907\\u4efd\",\"link\":\"Database\\/backup\",\"pid\":','0','0.0.0.0','1','1369596655','0'),(9,'/Menu/edit/id/73.html',NULL,'{\"id\":\"73\",\"name\":null,\"title\":\"\\u5907\\u4efd\\u5217\\u8868\",\"link\":\"Database\\/index\",\"pid\":\"71\",\"level','0','0.0.0.0','1','1369596661','0'),(10,'/Menu/edit/id/71.html',NULL,'{\"id\":\"71\",\"name\":\"\\u6570\\u636e\\u5e93\\u5907\\u4efd\",\"title\":\"\\u6570\\u636e\\u5907\\u4efd\",\"link\":\"Backup','0','0.0.0.0','1','1369597012','0'),(11,'/Menu/edit/id/72.html',NULL,'{\"id\":\"72\",\"name\":\"\\u5907\\u4efd\\u5217\\u8868\",\"title\":\"\\u5907\\u4efd\",\"link\":\"Backup\\/backup\",\"pid\":\"7','0','0.0.0.0','1','1369597020','0'),(12,'/Menu/edit/id/73.html',NULL,'{\"id\":\"73\",\"name\":null,\"title\":\"\\u5907\\u4efd\\u5217\\u8868\",\"link\":\"Backup\\/index\",\"pid\":\"71\",\"level\":','0','0.0.0.0','1','1369597028','0');
...
INSERT INTO `menu` VALUES (21,'菜单管理','菜单管理','Menu/index',26,1,0,'_self','left','1','\0',NULL),(22,'主页','主页','http://rockefys.github.io/commlib',0,0,0,'_blank','top','1','\0',''),(23,'用户管理','用户管理','User/index',26,1,0,'_self','left','1','\0',NULL),(24,'角色管理','角色管理','Role/index',26,1,0,'_self','left','1','\0',NULL),(25,'权限管理','权限管理','Authority/index',26,1,0,'_self','left','1','\0',NULL),(26,'基础数据','基础数据','',0,0,40,'_self','top','1','\0',''),(27,'内容管理','内容管理','',0,0,30,'_self','top','1','\0',''),(28,'新闻 ','新闻 ','Article/index',27,1,0,'_self','left','1','\0',NULL),(29,'参数设置','参数设置','Parameters/index',26,1,0,'_self','left','1','\0',NULL),(30,'代码生成','代码生成','Code/index',26,1,0,'_self','left','1','\0',''),(31,'系统设置','系统设置','Config/index',26,1,0,'_self','left','0','\0',NULL),(33,'业务管理','业务管理','',0,0,10,'_self','top','1','\0',''),(34,'宽带管理','宽带管理','Broadband/index',33,1,0,'_self','left','1','\0',NULL),(35,'护照管理','护照管理','Passport/index',33,1,0,'_self','left','1','\0',NULL),(42,'个人中心','个人中心','',0,0,60,'_self','top','1','\0',''),(43,'个人信息','个人信息','User/profile',42,1,0,'_self','left','1','\0',NULL),(44,'修改密码','修改密码','User/changepwd',42,1,0,'_self','left','1','\0',NULL),(58,'宽带类别','宽带类别','Broadband_cat/index',34,2,1,'_self',NULL,'1','\0',''),(59,'表单设计器','表单设计器','Code/edit',30,2,1,'_self',NULL,'1','\0',''),(60,'关联模型','关联模型','Code/relation',30,2,4,'_self',NULL,'0','\0',''),(61,'模块管理','模块管理','Code/index',30,2,0,'_self',NULL,'1','\0',''),(62,'表间关系','表间关系','Code/refer',30,2,3,'_self',NULL,'1','\0',''),(63,'宽带列表','宽带列表','Broadband/index',34,2,0,'_self',NULL,'1','\0',''),(64,'系统管理','系统管理','',0,0,5,'_self',NULL,'1','\0',''),(65,'日志管理','日志管理','Log/index',64,1,0,'_self',NULL,'1','\0',''),(66,'预览生成','预览生成','Code/view',30,2,4,'_self',NULL,'1','\0',''),(67,'护照列表','护照列表','Passport/index',35,2,0,'_self',NULL,'1','\0',''),(68,'菜单列表','菜单列表','Menu/index',21,2,0,'_self',NULL,'1','\0',''),(69,'树形菜单','树形菜单','Menu/treeedit',21,2,1,'_self',NULL,'1','\0',''),(70,'树形只读菜单','树形只读菜单','Menu/tree',21,2,2,'_self',NULL,'1','\0',''),(71,'数据库备份','数据备份','Database/index',64,1,0,'_self',NULL,'1','\0',''),(72,'备份列表','备份','Database/backup',71,2,1,'_self',NULL,'1','\0',''),(73,NULL,'备份列表','Database/index',71,2,0,'_self',NULL,'1','\0','');
...
CREATE TABLE `module_column` (
  ...
  `control_type` enum('text','area','select','checkbox','date','datetime','time','hidden','digit','refer','getField') DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='模块字段';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `module_column` VALUES ('account.activation_key','account','activation_key','','varchar(60)','',NULL,'\0','','','','\0','','',2,2,'text','{maxlength:60,}','','1',NULL),('account.admin_profile','account','admin_profile','','int(11)','','0','\0','','','','\0','','',1,1,'digit','{required:true,digits:true,range:[-2147483648,2147483647]}','','1',NULL),('account.failed_logins','account','failed_logins','','smallint(4) unsigned','','0','\0','','','','\0','','',8,8,'digit','{required:true,digits:true,range:[0,65535]}','','1',NULL),('account.id','account','id','','int(11) unsigned','',NULL,'\0','','','','\0','','',0,0,'digit','{digits:true,range:[0,4294967295]}','','1',NULL),('account.last_failed_attempt','account','last_failed_attempt','','datetime','',NULL,'\0','','','','\0','','',6,6,'','{required:true,dateISO:true,date:true,}','','1',NULL),('account.last_failed_ip','account','last_failed_ip','','varchar(15)','','','\0','','','','\0','','',10,10,'text','{required:true,maxlength:15,}','','1',NULL),('account.last_login_date','account','last_login_date','','datetime','',NULL,'\0','','','','\0','','',4,4,'','{required:true,dateISO:true,date:true,}','','1',NULL),('account.last_login_ip','account','last_login_ip','','varchar(40)','','','\0','','','','\0','','',7,7,'text','{required:true,maxlength:40,}','','1',NULL),('account.last_modified','account','last_modified','','datetime','',NULL,'\0','','','','\0','','',5,5,'','{required:true,dateISO:true,date:true,}','','1',NULL),('account.lockout_expires','account','lockout_expires','','int(11)','','0','\0','','','','\0','','',9,9,'digit','{required:true,digits:true,range:[-2147483648,2147483647]}','','1',NULL),('account.reset_token','account','reset_token','','varchar(60)','','','\0','','','','\0','','',3,3,'text','{required:true,maxlength:60,}','','1',NULL),('atest.checkbox','atest','checkbox','复选框','bit(1)','','',NULL,'','','','','','',6,6,'checkbox','{}','','1','eq'),('atest.datetime','atest','datetime','日期时间','datetime','','',NULL,'','','','','','',5,5,'datetime','{dateISO:true,date:true,}','','1','between'),('atest.decimal','atest','decimal','小数框','decimal(18,2)','','',NULL,'','','','\0','\0','\0',7,7,'text','{number:true,}','','1','eq'),('atest.id','atest','id','','int(11)','PRI','',NULL,'','','\0','\0','\0','\0',0,0,'hidden','{required:true,digits:true,range:[-2147483648,2147483647]}','','1','eq'),('atest.select','atest','select','列表框','enum(\'a\',\'b\',\'c\')','','',NULL,'','','','','','',3,3,'select','{}','','1','eq'),('atest.smallint','atest','smallint','整数框','smallint(6)','','',NULL,'','','','\0','\0','\0',8,8,'digit','{digits:true,range:[-32768,32767]}','','1','eq'),('atest.textarea','atest','textarea','多行文本框','text','','',NULL,'','','','\0','\0','\0',4,4,'area','{}','','1','eq'),('atest.textbox','atest','textbox','文本框','varchar(45)','','',NULL,'','','','','','',2,2,'text','{maxlength:45,}','','1','like'),('atest.time','atest','time','时间','time','','',NULL,'','','','\0','','',10,10,'time','{date:true,}','','1','eq'),('atest.tinytext','atest','tinytext','多行文本','tinytext','','',NULL,'','','','\0','\0','\0',9,9,'area','{}','','1','eq'),('atest.user_id','atest','user_id','用户名','int(10) unsigned','','',NULL,'','','','','','',1,1,'getField','{digits:true,range:[0,4294967295]}','','1','eq'),('attachment.description','attachment','description','','varchar(255)','',NULL,'\0','','','','\0','','',7,7,'text','{required:true,maxlength:255,}','','1',NULL),('attachment.downloads','attachment','downloads','','int(11) unsigned','','0','\0','','','','\0','','',8,8,'digit','{digits:true,range:[0,4294967295]}','','1',NULL),('attachment.extension','attachment','extension','','varchar(8)','',NULL,'\0','','','','\0','','',6,6,'text','{required:true,maxlength:8,}','','1',NULL),('attachment.file_name','attachment','file_name','','varchar(255)','','','\0','','','','\0','','',4,4,'text','{required:true,maxlength:255,}','','1',NULL),('attachment.file_size','attachment','file_size','','int(11) unsigned','','0','\0','','','','\0','','',5,5,'digit','{required:true,digits:true,range:[0,4294967295]}','','1',NULL),('attachment.id','attachment','id','','int(11) unsigned','PRI',NULL,'\0','','','\0','\0','\0','\0',0,0,'hidden','{required:true,digits:true,range:[0,4294967295]}','','1',NULL),('attachment.pid','attachment','pid','','int(11) unsigned','','0','\0','','','','\0','','',1,1,'digit','{required:true,digits:true,range:[0,4294967295]}','','1',NULL),('attachment.type','attachment','type','','varchar(20)','',NULL,'\0','','','','\0','','',2,2,'text','{maxlength:20,}','','1',NULL),('attachment.url','attachment','url','','varchar(255)','',NULL,'\0','','','','\0','','',3,3,'text','{maxlength:255,}','','1',NULL),('broadband.cat_id','broadband','cat_id','类别','int(11)','','',NULL,'','','','','','',3,3,'refer','{digits:true,range:[-2147483648,2147483647]}','','1','eq'),('broadband.cost','broadband','cost','安装费用','decimal(18,2)','','',NULL,'','','','\0','','',7,7,'digit','{number:true,}','','1','eq'),('broadband.end_date','broadband','end_date','结束日期','date','','',NULL,'','','','','','',5,5,'date','{}','','1','between'),('broadband.id','broadband','id','','int(10) unsigned','PRI','',NULL,'','','\0','\0','\0','\0',0,0,'hidden','{required:true,digits:true,range:[0,4294967295]}','','1','eq'),('broadband.is_deleted','broadband','is_deleted','','varchar(45)','','0',NULL,'','','','\0','\0','\0',15,15,'text','{maxlength:45,}','','1','eq'),('broadband.manager','broadband','manager','发展人','int(11)','','',NULL,'','','','','','',8,8,'digit','{digits:true,range:[-2147483648,2147483647]}','','1','like'),('broadband.memo','broadband','memo','备注','varchar(255)','','',NULL,'','','','\0','\0','',9,9,'text','{maxlength:255,}','','1','eq'),('broadband.password','broadband','password','宽带密码','varchar(255)','','',NULL,'','','','\0','','',11,11,'text','{maxlength:255,}','','1','eq'),('broadband.phone','broadband','phone','宽带手机号','varchar(255)','','',NULL,'','','','','','',2,2,'text','{maxlength:255,}','','1','like'),('broadband.start_date','broadband','start_date','安装日期','date','','',NULL,'','','','','','',4,4,'date','{}','','1','between'),('broadband.status','broadband','status','状态','varchar(20)','','',NULL,'','','','\0','','',12,12,'text','{maxlength:20,}','','1','eq'),('broadband.update_time','broadband','update_time','','datetime','','',NULL,'','','','\0','\0','\0',14,14,'datetime','{dateISO:true,date:true,}','','1','between'),('broadband.update_user','broadband','update_user','','int(11)','','',NULL,'','','','\0','\0','\0',13,13,'digit','{digits:true,range:[-2147483648,2147483647]}','','1','eq'),('broadband.username','broadband','username','宽带账号','varchar(255)','','',NULL,'','','','\0','','',10,10,'text','{maxlength:255,}','','1','eq'),('broadband.user_id','broadband','user_id','用户','int(11)','','',NULL,'','','','','','',1,1,'refer','{digits:true,range:[-2147483648,2147483647]}','','1','eq'),('broadband.use_during','broadband','use_during','使用时长','smallint(6)','','',NULL,'','','','','','',6,6,'digit','{digits:true,range:[-32768,32767]}','','1','eq'),('cron.available','cron','available','','varchar(255)','MUL','0','\0','','','','\0','','',1,1,'text','{required:true,maxlength:255,}','','1','eq'),('cron.day','cron','day','','tinyint(2)','','0','\0','','','','\0','','',8,8,'digit','{required:true,digits:true,range:[-128,127]}','','1','eq'),('cron.filename','cron','filename','','varchar(255)','','','\0','','','','\0','','',4,4,'text','{required:true,maxlength:255,}','','1','eq'),('cron.hour','cron','hour','','tinyint(2)','','0','\0','','','','\0','','',9,9,'digit','{required:true,digits:true,range:[-128,127]}','','1','eq'),('cron.id','cron','id','','smallint(6) unsigned','PRI',NULL,'\0','','','\0','\0','\0','\0',0,0,'hidden','{required:true,digits:true,range:[0,65535]}','','1','eq'),('cron.lastrun','cron','lastrun','','int(10) unsigned','','0','\0','','','','\0','','',5,5,'digit','{required:true,digits:true,range:[0,4294967295]}','','1','eq'),('cron.minute','cron','minute','','char(36)','','','\0','','','','\0','','',10,10,'text','{required:true,maxlength:36,}','','1','eq'),('cron.name','cron','name','','varchar(50)','','','\0','','','','\0','','',3,3,'text','{required:true,maxlength:50,}','','1','eq'),('cron.nextrun','cron','nextrun','','int(10) unsigned','','0','\0','','','','\0','','',6,6,'digit','{required:true,digits:true,range:[0,4294967295]}','','1','eq'),('cron.type','cron','type','','enum(\'user\',\'system\')','',NULL,'\0','','','','\0','','',2,2,'select','{required:true,}','','1','eq'),('cron.weekday','cron','weekday','','tinyint(1)','','0','\0','','','','\0','','',7,7,'digit','{required:true,digits:true,range:[-128,127]}','','1','eq'),('log.content','log','content','','varchar(100)','','',NULL,'','','','\0','\0','\0',3,3,'text','{maxlength:100,}','','1','eq'),('log.id','log','id','','int(10) unsigned','PRI','',NULL,'','','\0','\0','\0','\0',0,0,'hidden','{required:true,digits:true,range:[0,4294967295]}','','1','eq'),('log.ip','log','ip','IP','varchar(45)','','',NULL,'','','','','','\0',5,5,'text','{maxlength:45,}','','1','like'),('log.operate','log','operate','操作路径','varchar(100)','','',NULL,'','','','\0','','\0',1,1,'text','{maxlength:100,}','','1','like'),('log.para','log','para','','varchar(45)','','',NULL,'','','','\0','\0','\0',2,2,'text','{maxlength:45,}','','1','eq'),('log.result','log','result','','varchar(45)','','',NULL,'','','','\0','\0','\0',4,4,'text','{maxlength:45,}','','1','eq'),('log.status','log','status','','varchar(45)','','0',NULL,'','','','\0','','\0',8,8,'text','{maxlength:45,}','','1','eq'),('log.update_time','log','update_time','时间','varchar(45)','','',NULL,'','','','','','\0',7,7,'text','{maxlength:45,}','','1','between'),('log.update_user','log','update_user','用户','varchar(45)','','',NULL,'','','','','','\0',6,6,'refer','{maxlength:45,}','','1','eq'),('module_column.add_order','module_column','add_order','','smallint(5) unsigned','',NULL,'\0','','','','\0','','',15,15,'digit','{digits:true,range:[0,65535]}','','1',NULL),('module_column.add_show','module_column','add_show','','bit(1)','','b\'1\'','\0','','','','\0','','',13,13,'checkbox','{required:true,}','','1',NULL),('module_column.control_type','module_column','control_type','','enum(\'text\',\'area\',\'select\',\'checkbox\',\'date\',\'datetime\',\'time\',\'hidden\',\'digit\',\'refer\',\'getField\')','',NULL,'\0','','','','\0','','',16,16,'area','{dateISO:true,date:true,}','','1',NULL),('module_column.default','module_column','default','','varchar(100)','',NULL,'\0','','','','\0','','',6,6,'text','{maxlength:100,}','','1',NULL),('module_column.empty','module_column','empty','','bit(1)','',NULL,'\0','','','','\0','','',8,8,'checkbox','{}','','1',NULL),('module_column.field','module_column','field','名称','varchar(100)','',NULL,'\0','','','','\0','','',2,2,'text','{required:true,maxlength:100,}','','1',NULL),('module_column.id','module_column','id','','varchar(100)','PRI',NULL,'\0','','','\0','\0','\0','\0',0,0,'hidden','{required:true,maxlength:100,}','','1',NULL),('module_column.insert_able','module_column','insert_able','','bit(1)','',NULL,'\0','','','','\0','','',9,9,'checkbox','{}','','1',NULL),('module_column.list_order','module_column','list_order','','smallint(5) unsigned','',NULL,'\0','','','','\0','','',14,14,'digit','{digits:true,range:[0,65535]}','','1',NULL),('module_column.list_show','module_column','list_show','','bit(1)','','b\'1\'','\0','','','','\0','','',12,12,'checkbox','{required:true,}','','1',NULL),('module_column.module','module_column','module','','varchar(45)','',NULL,'\0','','','','\0','','',1,1,'text','{required:true,maxlength:45,}','','1',NULL),('module_column.pk','module_column','pk','','varchar(45)','',NULL,'\0','','','','\0','','',5,5,'text','{maxlength:45,}','','1',NULL),('module_column.query_able','module_column','query_able','','bit(1)','','b\'0\'','\0','','','','\0','','',11,11,'checkbox','{required:true,}','','1',NULL),('module_column.query_type','module_column','query_type','','varchar(45)','',NULL,'\0','','','','\0','','',20,20,'text','{maxlength:45,}','','1',NULL),('module_column.readonly','module_column','readonly','','bit(1)','',NULL,'\0','','','','\0','','',7,7,'checkbox','{}','','1',NULL),('module_column.status','module_column','status','','varchar(45)','',NULL,'\0','','','','\0','','',19,19,'text','{maxlength:45,}','','1',NULL),('module_column.tips','module_column','tips','','varchar(100)','',NULL,'\0','','','','\0','','',18,18,'text','{maxlength:100,}','','1',NULL),('module_column.title','module_column','title','','varchar(45)','',NULL,'\0','','','','\0','','',3,3,'text','{required:true,maxlength:45,}','','1',NULL),('module_column.type','module_column','type','','varchar(255)','',NULL,'\0','','','','\0','','',4,4,'text','{maxlength:255,}','','1',NULL),('module_column.update_able','module_column','update_able','','bit(1)','',NULL,'\0','','','','\0','','',10,10,'checkbox','{}','','1',NULL),('module_column.validate','module_column','validate','','varchar(255)','','','\0','','','','\0','','',17,17,'text','{maxlength:255,}','','1',NULL),('module_refer.as_fields','module_refer','as_fields','映射字段','varchar(1000)','','',NULL,'','','','\0','\0','',13,13,'text','{maxlength:1000,}','','1','eq'),('module_refer.condition','module_refer','condition','参照条件','varchar(100)','','',NULL,'','','','\0','','',5,5,'text','{maxlength:100,}','','1','eq'),('module_refer.field_show','module_refer','field_show','显示字段','varchar(45)','','',NULL,'','','','\0','','',14,14,'text','{maxlength:45,}','','1','eq'),('module_refer.fk','module_refer','fk','参照外键','varchar(45)','','',NULL,'','','','\0','','',2,2,'text','{maxlength:45,}','','1','eq'),('module_refer.fk_id','module_refer','fk_id','','varchar(100)','','',NULL,'','','','\0','\0','\0',6,6,'text','{maxlength:100,}','','1','eq'),('module_refer.id','module_refer','id','','varchar(100)','PRI','',NULL,'','','\0','\0','\0','\0',0,0,'hidden','{required:true,maxlength:100,}','','1','eq'),('module_refer.limit','module_refer','limit','关联条目','varchar(45)','','',NULL,'','','','\0','','',16,16,'text','{maxlength:45,}','','1','eq'),('module_refer.map_fields','module_refer','map_fields','关联字段','varchar(1000)','','',NULL,'','','','\0','\0','\0',12,12,'text','{maxlength:1000,}','','1','eq'),('module_refer.map_name','module_refer','map_name','映射名称','varchar(45)','','',NULL,'','','','\0','\0','\0',9,9,'text','{maxlength:45,}','','1','eq'),('module_refer.map_type','module_refer','map_type','关联类型','varchar(45)','','',NULL,'','','','\0','\0','\0',10,10,'text','{maxlength:45,}','','1','eq'),('module_refer.module','module_refer','module','参照表名','varchar(100)','','',NULL,'','','','\0','','',1,1,'text','{maxlength:100,}','','1','eq'),('module_refer.module_refer','module_refer','module_refer','被参照表','varchar(100)','','',NULL,'','','','\0','','',3,3,'text','{maxlength:100,}','','1','eq'),('module_refer.order','module_refer','order','关联顺序','varchar(45)','','',NULL,'','','','\0','\0','\0',15,15,'text','{maxlength:45,}','','1','eq'),('module_refer.pk','module_refer','pk','参照主键','varchar(45)','','',NULL,'','','','\0','','',4,4,'text','{maxlength:45,}','','1','eq'),('module_refer.pk_id','module_refer','pk_id','','varchar(100)','','',NULL,'','','','\0','\0','\0',7,7,'text','{maxlength:100,}','','1','eq'),('module_refer.refer_type','module_refer','refer_type','参照类型','enum(\'INNER\',\'LEFT\',\'RIGHT\',\'FULL\')','','INNER',NULL,'','','','\0','','',11,11,'select','{}','','1','eq'),('module_refer.relation_table','module_refer','relation_table','','varchar(45)','','',NULL,'','','','\0','\0','\0',8,8,'text','{maxlength:45,}','','1','eq'),('module_refer.status','module_refer','status','','varchar(45)','','1',NULL,'','','','\0','\0','\0',17,17,'text','{maxlength:45,}','','1','eq'),('module_refer.type','module_refer','type','','varchar(45)','','refer',NULL,'','','','\0','\0','\0',18,18,'text','{maxlength:45,}','','1','eq'),('parameter.default','parameter','default','','varchar(100)','',NULL,'\0','','','','\0','','',3,3,'text','{maxlength:100,}','','1','eq'),('parameter.desc','parameter','desc','','varchar(255)','',NULL,'\0','','','','\0','','',5,5,'text','{maxlength:255,}','','1','eq'),('parameter.id','parameter','id','','int(11) unsigned','PRI',NULL,'\0','','','\0','\0','\0','\0',0,0,'hidden','{required:true,digits:true,range:[0,4294967295]}','','1','eq'),('parameter.is_node','parameter','is_node','','bit(1)','',NULL,'\0','','','','\0','','',7,7,'checkbox','{}','','1','eq'),('parameter.level','parameter','level','','smallint(6) unsigned','',NULL,'\0','','','','\0','','',8,8,'digit','{digits:true,range:[0,65535]}','','1','eq'),('parameter.name','parameter','name','','varchar(50)','UNI',NULL,'\0','','','','\0','','',1,1,'text','{maxlength:50,}','','1','eq'),('parameter.parent','parameter','parent','','int(11) unsigned','',NULL,'\0','','','','\0','','',6,6,'digit','{digits:true,range:[0,4294967295]}','','1','eq'),('parameter.type','parameter','type','','varchar(20)','',NULL,'\0','','','','\0','','',4,4,'text','{maxlength:20,}','','1','eq'),('parameter.value','parameter','value','','varchar(100)','',NULL,'\0','','','','\0','','',2,2,'text','{maxlength:100,}','','1','eq'),('passport.authority','passport','authority','签发机关','varchar(100)','',NULL,'\0','','','','\0','','',11,11,'text','{maxlength:100,}','','1',NULL),('passport.birthday','passport','birthday','出生日期','date','',NULL,'\0','','','','\0','','',6,6,'date','{}','','1',NULL),('passport.birth_place','passport','birth_place','出生地','varchar(100)','',NULL,'\0','','','','\0','','',7,7,'text','{maxlength:100,}','','1',NULL),('passport.expiry','passport','expiry','过期日期','date','',NULL,'\0','','','','\0','','',10,10,'date','{}','','1',NULL),('passport.id','passport','id','','int(10) unsigned','PRI',NULL,'\0','','','\0','\0','\0','\0',0,0,'hidden','{required:true,digits:true,range:[0,4294967295]}','','1',NULL),('passport.issue_date','passport','issue_date','签发日期','date','',NULL,'\0','','','','\0','','',9,9,'date','{}','','1',NULL),('passport.issue_place','passport','issue_place','签发地','varchar(100)','',NULL,'\0','','','','\0','','',8,8,'text','{maxlength:100,}','','1',NULL),('passport.ming','passport','ming','名','varchar(20)','',NULL,'\0','','','','\0','','',4,4,'text','{maxlength:20,}','','1',NULL),('passport.numb','passport','numb','护照编号','varchar(50)','',NULL,'\0','','','','\0','','',2,2,'text','{maxlength:50,}','','1',NULL),('passport.sex','passport','sex','性别','enum(\'男\',\'女\')','','男','\0','','','','\0','','',5,5,'select','{}','','1',NULL),('passport.update_time','passport','update_time','','datetime','',NULL,'\0','','','','\0','','',13,13,'datetime','{dateISO:true,date:true,}','','1',NULL),('passport.update_user','passport','update_user','','int(11)','',NULL,'\0','','','','\0','','',12,12,'digit','{digits:true,range:[-2147483648,2147483647]}','','1',NULL),('passport.userid','passport','userid','用户','int(10) unsigned','',NULL,'\0','','','','\0','','',1,1,'refer','{digits:true,range:[0,4294967295]}','','1',NULL),('passport.xing','passport','xing','姓','varchar(20)','',NULL,'\0','','','','\0','','',3,3,'text','{maxlength:20,}','','1',NULL),('test.BIGINT','test','BIGINT','BIGINT','bigint(20)','',NULL,'\0','','','','\0','','',17,17,'digit','{required:true,digits:true,range:[-9223372036854775808,9223372036854775807]}','','1','eq'),('test.BIT','test','BIT','BIT','bit(1)','',NULL,'\0','','','','\0','','',18,18,'checkbox','{required:true,}','','1','eq'),('test.BLOB','test','BLOB','BLOB','blob','',NULL,'\0','','','','\0','','',3,3,NULL,'{required:true,}','','1','eq'),('test.char20','test','char20','char20','char(20)','',NULL,'\0','','','','\0','','',1,1,'text','{required:true,maxlength:20,}','','1','eq'),('test.DATE','test','DATE','DAT','date','',NULL,'\0','','','','\0','','',5,5,'date','{required:true,}','','1','between'),('test.DATETIME','test','DATETIME','DATETIME','datetime','',NULL,'\0','','','','\0','','',7,7,'datetime','{required:true,dateISO:true,date:true,}','','1','between'),('test.DECIMAL','test','DECIMAL','DECIMAL','decimal(10,0)','',NULL,'\0','','','','\0','','',16,16,'digit','{required:true,number:true,}','','1','eq'),('test.DOUBLE','test','DOUBLE','DOUBLE','double','',NULL,'\0','','','','\0','','',15,15,'digit','{required:true,number:true,}','','1','eq'),('test.ENUMab','test','ENUMab','ENUMab','enum(\'a\',\'b\')','',NULL,'\0','','','','\0','','',19,19,'select','{required:true,}','','1','eq'),('test.FLOAT','test','FLOAT','FLOAT','float','',NULL,'\0','','','','\0','','',14,14,'digit','{required:true,number:true,}','','1','eq'),('test.id','test','id','','int(10) unsigned','PRI',NULL,'\0','','','\0','\0','\0','\0',0,0,'hidden','{required:true,digits:true,range:[0,4294967295]}','','1','eq'),('test.INT','test','INT','INT','int(11)','',NULL,'\0','','','','\0','','',13,13,'digit','{required:true,digits:true,range:[-2147483648,2147483647]}','','1','eq'),('test.LONGTEXT','test','LONGTEXT','LONGTEXT','longtext','',NULL,'\0','','','','\0','','',21,21,'area','{required:true,}','','1','eq'),('test.MEDIUMINT','test','MEDIUMINT','MEDIUMINT','mediumint(9)','',NULL,'\0','','','','\0','','',12,12,'digit','{required:true,digits:true,range:[-8388608,8388607]}','','1','eq'),('test.MEDIUMTEXT','test','MEDIUMTEXT','MEDIUMTEXT','mediumtext','',NULL,'\0','','','','\0','','',22,22,'area','{required:true,}','','1','eq'),('test.setabc','test','setabc','setabc','set(\'a\',\'b\',\'c\')','',NULL,'\0','','','','\0','','',20,20,NULL,'{required:true,}','','1','eq'),('test.SMALLINT','test','SMALLINT','SMALLINT','smallint(6) unsigned','',NULL,'\0','','','','\0','','',11,11,'digit','{required:true,digits:true,range:[0,65535]}','','1','eq'),('test.TEXT','test','TEXT','TEXT','text','',NULL,'\0','','','','\0','','',23,23,'area','{required:true,}','','1','eq'),('test.TIME','test','TIME','TIME','time','',NULL,'\0','','','','\0','','',6,6,'time','{required:true,date:true,}','','1','eq'),('test.TIMESTAMP','test','TIMESTAMP','TIMESPAMP','timestamp','','CURRENT_TIMESTAMP','\0','','','','\0','','',8,8,'datetime','{required:true,dateISO:true,date:true,}','','1','eq'),('test.TINYBLOB','test','TINYBLOB','TINYBLOB','tinyblob','',NULL,'\0','','','','\0','','',4,4,NULL,'{required:true,}','','1','eq'),('test.TINYINT','test','TINYINT','TINYINT','tinyint(4) unsigned','',NULL,'\0','','','','\0','','',10,10,'digit','{required:true,digits:true,range:[0,255]}','','1','eq'),('test.TINYTEXT','test','TINYTEXT','TINYTEXT','tinytext','',NULL,'\0','','','','\0','','',24,24,'area','{required:true,}','','1','eq'),('test.varchar45','test','varchar45','varchar45','varchar(45)','',NULL,'\0','','','','\0','','',2,2,'text','{required:true,maxlength:45,}','','1','eq'),('test.YEAR','test','YEAR','YEAR','year(4)','',NULL,'\0','','','','\0','','',9,9,NULL,'{required:true,range:[0,9999],digits:true,}','','1','eq'),('user.card_id','user','card_id','身份证号','varchar(18)','',NULL,'\0','','','','\0','','',7,7,'text','{maxlength:18,}','','1',NULL),('user.display_name','user','display_name','姓名','varchar(50)','',NULL,'\0','','','','\0','','',4,4,'text','{maxlength:50,}','','1',NULL),('user.email','user','email','email','varchar(100)','',NULL,'\0','','','','\0','','',2,2,'text','{maxlength:100,}','','1',NULL),('user.id','user','id','','int(11) unsigned','PRI',NULL,'\0','','','\0','\0','\0','\0',0,0,'hidden','{required:true,digits:true,range:[0,4294967295]}','','1',NULL),('user.last_login_time','user','last_login_time','上次登录','datetime','',NULL,'\0','','','','\0','','',12,12,'datetime','{dateISO:true,date:true,}','','1',NULL),('user.password','user','password','密码','varchar(45)','',NULL,'\0','','','','\0','','',3,3,'text','{maxlength:45,}','','1',NULL),('user.phone','user','phone','手机','varchar(50)','',NULL,'\0','','','','\0','','',6,6,'text','{maxlength:50,}','','1',NULL),('user.photo','user','photo','头像','varchar(255)','',NULL,'\0','','','','\0','','',8,8,'text','{maxlength:255,}','','1',NULL),('user.qq','user','qq','qq','varchar(20)','',NULL,'\0','','','','\0','','',9,9,'text','{maxlength:20,}','','1',NULL),('user.register_time','user','register_time','注册时间','datetime','',NULL,'\0','','','','\0','','',11,11,'datetime','{dateISO:true,date:true,}','','1',NULL),('user.sex','user','sex','性别','enum(\'男\',\'女\',\'未知\')','','未知','\0','','','','\0','','',5,5,'select','{}','','1',NULL),('user.status','user','status','状态','varchar(255)','',NULL,'\0','','','','\0','','',13,13,'text','{maxlength:255,}','','1',NULL),('user.username','user','username','用户名','varchar(50)','',NULL,'\0','','','','\0','','',1,1,'text','{required:true,maxlength:50,}','','1',NULL),('user.weibo','user','weibo','微博','varchar(100)','',NULL,'\0','','','','\0','','',10,10,'text','{maxlength:100,}','','1',NULL);
...
CREATE TABLE `module_refer` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='表间关系';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `module_refer` VALUES ('broadband-cat_id-broadband_cat-id','broadband','cat_id','broadband_cat','id','broadband.cat_id=broadband_cat.id','broadband.cat_id','broadband_cat.id',NULL,'broadband_cat',NULL,'INNER','','','name','','','1','refer'),('broadband-user_id-user-id','broadband','user_id','user','id','broadband.user_id=user.id','broadband.user_id','user.id',NULL,'user',NULL,'INNER','','','username','','','1','refer'),('log-update_user-user-id','log','update_user','user','id','log.update_user=user.id','log.update_user','user.id',NULL,'user',NULL,'INNER','','','username','','','1','refer'),('passport-id-user-id','passport','id','user','id','passport.id=user.id','passport.id','user.id',NULL,'user',NULL,'INNER','','','username','','','1','refer');
...
INSERT INTO `module_table` VALUES ('account','','Account','Comm','0',0,16384,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:14','\0',NULL,NULL,NULL,'customer'),('article','文章','Article','Comm','0',7,114688,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:14','\0',NULL,NULL,NULL,'customer'),('atest','','Atest','Comm','0',6,16384,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:13','\0',NULL,NULL,NULL,'customer'),('attachment','附件','Attachment','Comm','0',0,16384,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:13','\0',NULL,NULL,NULL,'customer'),('authority','权限','Authority','Comm','0',7,16384,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:11','\0',NULL,NULL,NULL,'system'),('backup','备份','Backup','Comm','0',0,16384,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:15','\0',NULL,NULL,NULL,'system'),('broadband','宽带','Broadband','Comm','1',8,16384,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:12','\0','','',NULL,'customer'),('broadband_cat','宽带类别','Broadband_cat','Comm','0',9,16384,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:15','\0',NULL,NULL,NULL,'customer'),('comments','评论','Comments','Comm','0',0,16384,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:12','\0',NULL,NULL,NULL,'customer'),('cron','定时任务','Cron','Comm','1',0,16384,16384,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:11','\0',NULL,NULL,NULL,'customer'),('log','日志','Log','Comm','1',12,16384,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-23 23:36:41','\0','','',NULL,'customer'),('menu','菜单','Menu','Comm','0',33,16384,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:12','\0',NULL,NULL,NULL,'system'),('module','节点信息','Module','Comm','0',0,16384,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:11','\0',NULL,NULL,NULL,'system'),('module_column','模块字段','Module_column','Comm','0',153,49152,16384,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:13','\0',NULL,NULL,NULL,'system'),('module_refer','表间关系','Module_refer','Comm','0',4,16384,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-16 22:47:47','\0',NULL,NULL,NULL,'system'),('module_table','模块','Module_table','Comm','0',26,16384,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:14','\0',NULL,NULL,NULL,'system'),('parameter','参数','Parameter','Comm','1',3,16384,16384,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:12','\0',NULL,NULL,NULL,'system'),('passport','护照','Passport','Comm','0',1,16384,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:13','\0',NULL,NULL,NULL,'customer'),('role','角色','Role','Comm','0',4,16384,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:12','\0',NULL,NULL,NULL,'system'),('role_authority','角色权限','Role_authority','Comm','0',18,16384,16384,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:11','\0',NULL,NULL,NULL,'system'),('test','字段示例','Test','Comm','0',0,16384,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:13','\0',NULL,NULL,NULL,'customer'),('topic','文章信息','Topic','Comm','0',1175,114688,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:14','\0',NULL,NULL,NULL,'customer'),('user','用户','User','Comm','0',1,16384,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:12','\0',NULL,NULL,NULL,'system'),('user_authority','特殊权限','User_authority','Comm','0',0,16384,16384,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:12','\0',NULL,NULL,NULL,'system'),('user_profile','用户信息','User_profile','Comm','0',0,16384,0,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:13','\0',NULL,NULL,NULL,'customer'),('user_role','用户角色','User_role','Comm','0',0,16384,16384,'InnoDB','utf8_general_ci',NULL,NULL,'2013-05-05 23:16:13','\0',NULL,NULL,NULL,'system');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='参数';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `parameter` VALUES (1,'para','100','10','asdf','asdf',NULL,NULL,NULL),(2,'allowRegister','no','yes','user','是否开启注册',NULL,NULL,NULL),(3,'allowAnanouys','no','no','user','是否允许匿名访问',NULL,NULL,NULL);
...
CREATE TABLE `passport` (
  ...
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='护照';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=232 DEFAULT CHARSET=utf8 COMMENT='角色权限';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `test` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `char20` char(20) NOT NULL COMMENT 'char20',
  `varchar45` varchar(45) NOT NULL COMMENT 'varchar45',
  `BLOB` blob NOT NULL COMMENT 'BLOB',
  `TINYBLOB` tinyblob NOT NULL COMMENT 'TINYBLOB',
  `DATE` date NOT NULL COMMENT 'DAT',
  `TIME` time NOT NULL COMMENT 'TIME',
  `DATETIME` datetime NOT NULL COMMENT 'DATETIME',
  `TIMESTAMP` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'TIMESPAMP',
  `YEAR` year(4) NOT NULL COMMENT 'YEAR',
  `TINYINT` tinyint(4) unsigned NOT NULL COMMENT 'TINYINT',
  `SMALLINT` smallint(6) unsigned NOT NULL COMMENT 'SMALLINT',
  `MEDIUMINT` mediumint(9) NOT NULL COMMENT 'MEDIUMINT',
  `INT` int(11) NOT NULL COMMENT 'INT',
  `FLOAT` float NOT NULL COMMENT 'FLOAT',
  `DOUBLE` double NOT NULL COMMENT 'DOUBLE',
  `DECIMAL` decimal(10,0) NOT NULL COMMENT 'DECIMAL',
  `BIGINT` bigint(20) NOT NULL COMMENT 'BIGINT',
  `BIT` bit(1) NOT NULL COMMENT 'BIT',
  `ENUMab` enum('a','b') NOT NULL COMMENT 'ENUMab',
  `setabc` set('a','b','c') NOT NULL COMMENT 'setabc',
  `LONGTEXT` longtext NOT NULL COMMENT 'LONGTEXT',
  `MEDIUMTEXT` mediumtext NOT NULL COMMENT 'MEDIUMTEXT',
  `TEXT` text NOT NULL COMMENT 'TEXT',
  `TINYTEXT` tinytext NOT NULL COMMENT 'TINYTEXT',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='字段示例';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='特殊权限';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-05-27 10:19:53
